...
import { Pair, Fraction } from '@kalycoinproject/sdk'
import { Panel, OptionButton, OptionsWrapper, Divider, MigrateButton, InnerWrapper } from './styleds'
import Stat from '../Stat'
import { Text, Box, DoubleCurrencyLogo } from '@kalycoinproject/components'
      ...
      <InnerWrapper>
        <Box>
          <Stat
            ...
            stat={`${totalLiqAmount ? totalLiqAmount.toSignificant(6) : '-'} KSL`}
