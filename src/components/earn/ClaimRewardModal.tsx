      ...
      await stakingContract[method](...args)
        .then((response: TransactionResponse) => {
          addTransaction(response, {
            summary: t('earn.claimAccumulated', { symbol: 'KSWAP' })
          })
        ...
        <ContentWrapper gap="lg">
          ...
          {stakingInfo?.earnedAmount && (
            <AutoColumn justify="center" gap="md">
              ...
              <TYPE.body>{t('earn.unclaimedReward', { symbol: 'KSWAP' })}</TYPE.body>
            </AutoColumn>
          )}
          {isSuperFarm &&
          ...
          >
            {errorMessage ? errorMessage : isSuperFarm ? t('earn.claim') : t('earn.claimReward', { symbol: 'KSWAP' })}
          </ButtonError>
        </ContentWrapper>
      )}
      {attempting && !hash && (
