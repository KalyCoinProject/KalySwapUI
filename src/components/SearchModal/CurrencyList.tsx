import { Currency, CurrencyAmount, currencyEquals, KLC, Token, ChainId } from '@kalycoinproject/sdk'
...
export default function CurrencyList({
  ...
  const itemData = useMemo(() => (showETH ? [KLC[chainId], ...currencies] : currencies), [
    currencies,
    showETH,
    chainId
  ])
