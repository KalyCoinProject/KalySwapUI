...
import { Text } from '@kalycoinproject/components'
...
export default function URLWarning() {
  ...
  return isMobile ? (
    <PhishAlert isActive={showURLWarning}>
      <div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        <code style={{ padding: '0 4px', display: 'inline', fontWeight: 'bold' }}>app.kalyswap.io</code>
        {!isBeta && (
  ...
  ) : window.location.hostname === 'app.kalyswap.io' ? (
    <PhishAlert isActive={showURLWarning}>
      <div style={{ display: 'flex', alignItems: 'center' }}>
