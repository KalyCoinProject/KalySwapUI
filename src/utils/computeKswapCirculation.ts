import { JSBI, Token, TokenAmount } from '@kalycoinproject/sdk'
...
export function computeKswapCirculation(kswap: Token, blockTimestamp: BigNumber): TokenAmount {
  ...
  return new TokenAmount(kswap, JSBI.multiply(wholeAmount, JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(18))))
}
