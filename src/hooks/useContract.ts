...
import Airdrop from '@kalycoinproject/governance/artifacts/contracts/Airdrop.sol/Airdrop.json'
import GovernorAlpha from '@kalycoinproject/governance/artifacts/contracts/GovernorAlpha.sol/GovernorAlpha.json'
import Kswap from '@kalycoinproject/governance/artifacts/contracts/KSWAP.sol/Kswap.json'
import KalyswapBridgeMigrationRouter from '@kalycoinproject/exchange-contracts/artifacts/contracts/kalyswap-periphery/KalyswapBridgeMigrationRouter.sol/KalyswapBridgeMigrationRouter.json'
import MiniChefV2 from '@kalycoinproject/governance/artifacts/contracts/MiniChefV2.sol/MiniChefV2.json'
...
export function useBridgeMigratorContract(): Contract | null {
  return useContract(BRIDGE_MIGRATOR_ADDRESS, KalyswapBridgeMigrationRouter.abi, true)
}
...
export function usePairContract(pairAddress?: string, withSignerIfPossible?: boolean): Contract | null {
  return useContract(pairAddress, IKalyswapPair.abi, withSignerIfPossible)
}
...
export function useKswapContract(): Contract | null {
  const chainId = useChainId()
  return useContract(chainId ? KSWAP[chainId].address : undefined, Kswap.abi, true)
}
