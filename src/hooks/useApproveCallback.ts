...
import { Trade, TokenAmount, CurrencyAmount, KLC, ChainId } from '@kalycoinproject/sdk'
...
export function useApproveCallback(
  ...
  const approvalState: ApprovalState = useMemo(() => {
    ...
    if (chainId && amountToApprove.currency === KLC[chainId]) return ApprovalState.APPROVED
