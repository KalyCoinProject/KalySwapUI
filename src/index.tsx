...
import { NetworkContextName, KalyswapProvider } from '@kalycoinproject/components'
...
try {
  Sentry.init({
    ...
    ignoreErrors: [
      ...
      'Blocked a frame with origin "https://app.kalyswap.io" from accessing a cross-origin frame.'
    ]
  })
} catch (error) {
  console.log(error)
...
const ComponentThemeProvider = () => {
  ...
  return (
    <KalyswapProvider library={library} chainId={chainId} account={account ?? undefined} theme={theme as any}>
