    ...
    Promise.all(
      stakingInfos
        ...
        .sort(function(info_a, info_b) {
          // greater stake in kswap comes first
          return info_a.totalStakedInKswap?.greaterThan(info_b.totalStakedInKswap ?? BIG_INT_ZERO) ? -1 : 1
        })
        .sort(function(info_a, info_b) {
      ...
      <TopSection gap="md">
        <DataCard>
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>{t('earnPage.kalyswapLiquidityStaking')}</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>{t('earnPage.depositKalyswapStaking')}</TYPE.white>
              </RowBetween>
            </AutoColumn>
          </CardSection>
        </DataCard>
