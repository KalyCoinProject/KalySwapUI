...
import { Currency, currencyEquals, KLC, Percent, WKLC } from '@kalycoinproject/sdk'
...
export default function RemoveLiquidity({
  ...
  async function onRemove() {
    ...
    const currencyBIsETH = currencyB === KLC[chainId]
    const oneCurrencyIsETH = currencyA === KLC[chainId] || currencyBIsETH
  ...
  const oneCurrencyIsKLC = currencyA === KLC[chainId] || currencyB === KLC[chainId]
    ...
    <>
                  ...
                  <AutoColumn gap="10px">
                    ...
                    {chainId && (oneCurrencyIsWKLC || oneCurrencyIsKLC) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsKLC ? (
                          <StyledInternalLink
                            to={`/remove/${currencyA === KLC[chainId] ? WKLC[chainId].address : currencyIdA}/${
                              currencyB === KLC[chainId] ? WKLC[chainId].address : currencyIdB
                            }`}
                          >
      ...
      {pair ? (
        <AutoColumn style={{ minWidth: '20rem', width: '100%', maxWidth: '400px', marginTop: '1rem' }}>
          <MinimalPositionCard showUnwrapped={oneCurrencyIsWKLC} pair={pair} />
        </AutoColumn>
      ) : null}
    </>
  )
