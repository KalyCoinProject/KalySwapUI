...
import { Currency, currencyEquals, KLC, TokenAmount, WKLC } from '@kalycoinproject/sdk'
...
export default function AddLiquidity({
  ...
  const oneCurrencyIsWKLC = Boolean(
    chainId &&
      ((currencyA && currencyEquals(currencyA, WKLC[chainId])) ||
        (currencyB && currencyEquals(currencyB, WKLC[chainId])))
  )
  ...
  async function onAdd() {
    ...
    if (currencyA === KLC[chainId] || currencyB === KLC[chainId]) {
      const tokenBIsETH = currencyB === KLC[chainId]
      estimate = router.estimateGas.addLiquidityKLC
      method = router.addLiquidityKLC
      args = [
  ...
  const handleCurrencyBSelect = useCallback(
    (_currencyB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        history.push(`/add/${currencyIdA ? currencyIdA : 'KLC'}/${newCurrencyIdB}`)
      }
    },
