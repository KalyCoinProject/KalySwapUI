...
import { NewsWidget, WatchList, Portifolio } from '@kalycoinproject/components'
import { ChainId, CHAINS } from '@kalycoinproject/sdk'
...
const Dashboard = () => {
  ...
  const { chainId = ChainId.KALYCHAIN } = useActiveWeb3React()
  return (
    <PageWrapper>
