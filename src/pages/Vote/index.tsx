...
import { JSBI, TokenAmount, ChainId } from '@kalycoinproject/sdk'
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>{t('votePage.kalyswapGovernance')}</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>{t('votePage.earnedKswapTokens')}</TYPE.white>
              </RowBetween>
              <RowBetween>
      ...
      <TopSection gap="2px">
        <WrapSmall>
          ...
          {showUnlockVoting ? (
            ...
            <TYPE.body fontWeight={500} mr="6px">
              <FormattedCurrencyAmount currencyAmount={kswapBalance} /> {t('votePage.votes')}
            </TYPE.body>
          ) : (
            ''
          )}
