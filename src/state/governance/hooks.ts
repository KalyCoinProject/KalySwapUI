...
import { TokenAmount, JSBI } from '@kalycoinproject/sdk'
import { isAddress } from 'ethers/lib/utils'
import { useGovernanceContract, useKswapContract } from 'src/hooks/useContract'
...
import GOV from '@kalycoinproject/governance/artifacts/contracts/GovernorAlpha.sol/GovernorAlpha.json'
...
export function useUserDelegatee(): string {
  ...
  const uniContract = useKswapContract()
